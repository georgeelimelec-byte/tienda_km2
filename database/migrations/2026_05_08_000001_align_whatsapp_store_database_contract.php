    ...
    private function deleteOutOfScopeMigrationRows(): void
    {
        DB::table('migrations')
            ->whereIn('migration', [
                ...
                '2026_04_27_000001_add_hardware_fields_to_empresa_configuracion',
                '2026_04_27_000002_add_printer_target_host_to_empresa_configuracion',
                '2026_04_27_000003_add_printer_device_reference_to_empresa_configuracion',
