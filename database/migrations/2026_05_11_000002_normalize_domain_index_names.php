...
return new class extends Migration
{
    ...
    {
        $legacyStockMovementPrefix = 'stock_' . 'web_movimientos';
        $intermediateStockMovementPrefix = 'movimientos_stock_' . 'web';
        ...
        return [
            ...
            ['table' => 'movimientos_stock', 'old' => $legacyStockMovementPrefix . '_id_presentacion_foreign', 'new' => 'movimientos_stock_id_presentacion_foreign', 'column' => 'id_presentacion', 'references' => 'id_presentacion', 'on' => 'presentaciones_producto', 'on_delete' => 'cascade'],
            ['table' => 'movimientos_stock', 'old' => $legacyStockMovementPrefix . '_id_pedido_whatsapp_foreign', 'new' => 'movimientos_stock_id_pedido_whatsapp_foreign', 'column' => 'id_pedido_whatsapp', 'references' => 'id_pedido_whatsapp', 'on' => 'pedidos_tienda', 'on_delete' => 'set null'],
            ['table' => 'movimientos_stock', 'old' => $legacyStockMovementPrefix . '_id_usuario_foreign', 'new' => 'movimientos_stock_id_usuario_foreign', 'column' => 'id_usuario', 'references' => 'id_usuario', 'on' => 'usuarios_internos', 'on_delete' => 'set null'],
            ['table' => 'movimientos_stock', 'old' => $intermediateStockMovementPrefix . '_id_presentacion_foreign', 'new' => 'movimientos_stock_id_presentacion_foreign', 'column' => 'id_presentacion', 'references' => 'id_presentacion', 'on' => 'presentaciones_producto', 'on_delete' => 'cascade'],
            ['table' => 'movimientos_stock', 'old' => $intermediateStockMovementPrefix . '_id_pedido_whatsapp_foreign', 'new' => 'movimientos_stock_id_pedido_whatsapp_foreign', 'column' => 'id_pedido_whatsapp', 'references' => 'id_pedido_whatsapp', 'on' => 'pedidos_tienda', 'on_delete' => 'set null'],
            ['table' => 'movimientos_stock', 'old' => $intermediateStockMovementPrefix . '_id_usuario_foreign', 'new' => 'movimientos_stock_id_usuario_foreign', 'column' => 'id_usuario', 'references' => 'id_usuario', 'on' => 'usuarios_internos', 'on_delete' => 'set null'],
            ['table' => 'movimientos_stock', 'old' => 'stock_movimientos_id_presentacion_foreign', 'new' => 'movimientos_stock_id_presentacion_foreign', 'column' => 'id_presentacion', 'references' => 'id_presentacion', 'on' => 'presentaciones_producto', 'on_delete' => 'cascade'],
            ['table' => 'movimientos_stock', 'old' => 'stock_movimientos_id_pedido_whatsapp_foreign', 'new' => 'movimientos_stock_id_pedido_whatsapp_foreign', 'column' => 'id_pedido_whatsapp', 'references' => 'id_pedido_whatsapp', 'on' => 'pedidos_tienda', 'on_delete' => 'set null'],
            ['table' => 'movimientos_stock', 'old' => 'stock_movimientos_id_usuario_foreign', 'new' => 'movimientos_stock_id_usuario_foreign', 'column' => 'id_usuario', 'references' => 'id_usuario', 'on' => 'usuarios_internos', 'on_delete' => 'set null'],
