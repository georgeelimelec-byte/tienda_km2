...
| 11 | Catalogo tecnico | `/admin/inventory/products` | Presentaciones, codigos, precios, precio referencial y stock web. |
...
| 16 | Auditoria | `/admin/auditoria` | Acciones de usuarios y movimientos de stock web. |
...
| 19 | Configuracion | `/admin/configuracion` | Datos comerciales y apariencia de tienda. |
