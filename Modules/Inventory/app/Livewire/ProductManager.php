...
class ProductManager extends Component
{
    ...
    public function edit($id)
    {
        ...
        foreach ($product->presentaciones as $p) {
            $this->presentaciones[] = [
                ...
                'stock_web_minimo' => $p->stock_web_minimo,
    ...
    public function save()
    {
        $this->validate([
            ...
            'presentaciones.*.precio_referencial' => 'nullable|numeric|min:0',
            'presentaciones.*.costo_reposicion' => 'nullable|numeric|min:0',
            'presentaciones.*.stock_web' => 'required|integer|min:0',
            'presentaciones.*.stock_web_minimo' => 'nullable|integer|min:0',
            ...
            foreach ($this->presentaciones as $pData) {
                if (!empty($pData['id_presentacion'])) {
                    ...
                    $pres->update([
                        ...
                        'precio' => $pData['precio'],
                        'precio_referencial' => $pData['precio_referencial'] ?: null,
                        'stock_web' => max(0, (int) ($pData['stock_web'] ?? 0)),
                        'stock_web_minimo' => $pData['stock_web_minimo'] ?: 0,
