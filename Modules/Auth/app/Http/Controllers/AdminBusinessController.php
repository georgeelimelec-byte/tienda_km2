...
class AdminBusinessController extends Controller
{
    public function index(Request $request)
    {
        ...
        $categoryPerformance = PedidoWhatsappDetalle::query()
            ...
            ->join('productos', 'productos.id_producto', '=', 'detalle_pedidos_tienda.id_producto')
            ->join('categorias_producto', 'categorias_producto.id_categoria', '=', 'productos.id_categoria')
